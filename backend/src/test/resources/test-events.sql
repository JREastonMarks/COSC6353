...
INSERT INTO event (id, administrator_id, name, description, address, address2, city, state, zipcode, urgency, eventdate) 
VALUES (1, 1, 'Test Event', 'Event Description', '101 Main St', null, 'Houston', 'TX', '12345', 'Low', '2024-07-23');
